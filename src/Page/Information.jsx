...
<section class="features-section">
  <div class="container">
    <div class="text-center mb-5">
      <h2>Why Choose Us?</h2>
      <p class="text-muted">Discover what sets us apart in the world of laptops.</p>
    </div>
    <div class="row">
      ...
      <div class="col-md-6 mb-4">
        ...
        <img src="https://via.placeholder.com/500x300" alt="Support" class="img-fluid"/>
      </div>
    </div>
    <div class="row mt-5">
      <div class="col-md-4 text-center">
        <img src="https://via.placeholder.com/100" alt="Brands" class="mb-3"/>
        <h4>Top Brands</h4>
        <p class="text-muted">We partner with leading brands like Dell, HP, Lenovo, Asus, and more.</p>
      </div>
      <div class="col-md-4 text-center">
        <img src="https://via.placeholder.com/100" alt="Customizations" class="mb-3"/>
        <h4>Custom Upgrades</h4>
        <p class="text-muted">Customize your laptop with upgraded processors, memory, and storage options.</p>
      </div>
      <div class="col-md-4 text-center">
        <img src="https://via.placeholder.com/100" alt="Warranty" class="mb-3" />
        <h4>Warranty & Support</h4>
        <p class="text-muted">Every purchase is backed by warranties and reliable after-sales support.</p>
      </div>
    </div>
  </div>
</section>
