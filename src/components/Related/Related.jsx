    ...
    <div className=' p-2 mt-5'>
        ...
        <div data-aos="fade-right">
            <div className="related-left  max-w-md flex-column d-flex ">
                <p ><span  className="fw-bolder">ASUS ROG </span>GAMING LAPTOP</p>
                ...
                <div className="button-product d-flex gap-4">
                 <button className="btn-buy  rounded-5 fs-6 fw-bolder  d-flex align-items-center justify-content-center gap-1">
                  <Link to = '/asus' >
                  <span>BUY NOW</span><img src={card_shopping} width={20} alt='' /></Link>
                 </button>
                <button className="btn-info rounded-5 fs-6 fw-bolder bg-light">INFOR MORE!</button>
                </div>
