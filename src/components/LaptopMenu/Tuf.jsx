...
const Tuf = () => {
  return (
    ...
    <div className="accordion" id="filterAccordion">
      <div className="accordion-item tuf-cheak-box">
        <h2 className="accordion-header" id="seriesHeading">
          <button className="accordion-button btn-tuf" type="button" data-bs-toggle="collapse" data-bs-target="#seriesCollapse" aria-expanded="true" aria-controls="seriesCollapse">
            SERIES
          </button>
        </h2>
      ...
      <div className="accordion-item tuf-cheak-box">
        <h2 className="accordion-header" id="gpuHeading">
          <button className="accordion-button btn-tuf collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#gpuCollapse" aria-expanded="false" aria-controls="gpuCollapse">
            GPU
          </button>
        </h2>
      ...
      <div className="accordion-item tuf-cheak-box">
        <h2 className="accordion-header" id="cpuHeading">
          <button className="accordion-button btn-tuf collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#cpuCollapse" aria-expanded="false" aria-controls="cpuCollapse">
            CPU
          </button>
        </h2>
      ...
      <div className="accordion-item tuf-cheak-box">
        <h2 className="accordion-header" id="displaySizeHeading">
          <button className="accordion-button btn-tuf collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#displaySizeCollapse" aria-expanded="false" aria-controls="displaySizeCollapse">
            DISPLAY SIZE
          </button>
        </h2>
      ...
      <div className="accordion-item tuf-cheak-box">
        <h2 className="accordion-header" id="displayTypeHeading">
          <button className="accordion-button btn-tuf collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#displayTypeCollapse" aria-expanded="false" aria-controls="displayTypeCollapse">
            DISPLAY TYPE
          </button>
        </h2>
      ...
      <div className="accordion-item tuf-cheak-box">
        <h2 className="accordion-header" id="memoryHeading">
          <button className="accordion-button btn-tuf collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#memoryCollapse" aria-expanded="false" aria-controls="memoryCollapse">
            MEMORY
          </button>
        </h2>
      ...
      <div className="accordion-item tuf-cheak-box">
        <h2 className="accordion-header" id="storagHeading">
          <button className="accordion-button btn-tuf collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#storagCollapse" aria-expanded="false" aria-controls="storagCollapse">
            STORAGE
          </button>
        </h2>
      ...
      <div className="accordion-item tuf-cheak-box">
        <h2 className="accordion-header" id="connectivityHeading">
          <button className="accordion-button btn-tuf collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#connectivityCollapse" aria-expanded="false" aria-controls="connectivityCollapse">
            CONNECTIVITY
          </button>
        </h2>
      ...
      <div className="accordion-item tuf-cheak-box">
        <h2 className="accordion-header" id="betteryHeading">
          <button className="accordion-button btn-tuf collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#betteryCollapse" aria-expanded="false" aria-controls="betteryCollapse">
            BATTERY
          </button>
        </h2>
      ...
      <div className="accordion-item tuf-cheak-box">
        <h2 className="accordion-header" id="networkingHeading">
          <button className="accordion-button btn-tuf collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#networkingCollapse" aria-expanded="false" aria-controls="networkingCollapse">
            NETWORKING
          </button>
        </h2>
